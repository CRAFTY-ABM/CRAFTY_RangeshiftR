...
# scenarios_todo =  1:n_scenario # all scenarios
scenarios_todo =  c(1,3,5,7) # only the scenarios with social

# pres_todo = prefs[c(2,6,8,9)] # the four behavioural prefs selected
prefs_todo = prefs[c(9)] # the baseline behaviour  
